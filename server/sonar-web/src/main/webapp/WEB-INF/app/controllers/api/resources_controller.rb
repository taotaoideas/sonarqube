...
class Api::ResourcesController < Api::ApiController
  ...
  def resource_to_json(resource, snapshot, measures, rules_by_id, options={})
    ...
    json = {
      ...
      'date' => Api::Utils.format_datetime(Time.at(snapshot.created_at)),
    ...
    if include_trends
      ...
      json[:p1d]=Api::Utils.format_datetime(Time.at(snapshot.period1_date/1000)) if snapshot.period1_date

      json[:p2]=snapshot.period2_mode if snapshot.period2_mode
      json[:p2p]=snapshot.period2_param if snapshot.period2_param
      json[:p2d]=Api::Utils.format_datetime(Time.at(snapshot.period2_date/1000)) if snapshot.period2_date

      json[:p3]=snapshot.period3_mode if snapshot.period3_mode
      json[:p3p]=snapshot.period3_param if snapshot.period3_param
      json[:p3d]=Api::Utils.format_datetime(Time.at(snapshot.period3_date/1000)) if snapshot.period3_date

      json[:p4]=snapshot.period4_mode if snapshot.period4_mode
      json[:p4p]=snapshot.period4_param if snapshot.period4_param
      json[:p4d]=Api::Utils.format_datetime(Time.at(snapshot.period4_date/1000)) if snapshot.period4_date

      json[:p5]=snapshot.period5_mode if snapshot.period5_mode
      json[:p5p]=snapshot.period5_param if snapshot.period5_param
      json[:p5d]=Api::Utils.format_datetime(Time.at(snapshot.period5_date/1000)) if snapshot.period5_date
    end
    if measures
      json_measures=[]
  ...
  def resource_to_xml(xml, resource, snapshot, measures, rules_by_id, options={})
    ...
    xml.resource do
      ...
      xml.date(Api::Utils.format_datetime(Time.at(snapshot.created_at)))
      ...
      if include_trends
        ...
        xml.period1_date(Api::Utils.format_datetime(Time.at(snapshot.period1_date/1000))) if snapshot.period1_date
        ...
        xml.period2_date(Api::Utils.format_datetime(Time.at(snapshot.period2_date/1000))) if snapshot.period2_date
        ...
        xml.period3_date(Api::Utils.format_datetime(Time.at(snapshot.period3_date/1000))) if snapshot.period3_date
        ...
        xml.period4_date(Api::Utils.format_datetime(Time.at(snapshot.period4_date/1000))) if snapshot.period4_date
        ...
        xml.period5_date(Api::Utils.format_datetime(Time.at(snapshot.period5_date/1000))) if snapshot.period5_date
      end
