...
public class IssueIndexMediumTest {
  ...
  public void facets_on_projects() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("projectUuids")).containsOnly(new FacetBucket("ABCD", 2), new FacetBucket("EFGH", 1));
  }
  ...
  public void facets_on_components() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("fileUuids"))
      .containsOnly(new FacetBucket("A", 1), new FacetBucket("ABCD", 1), new FacetBucket("BCDE", 2), new FacetBucket("CDEF", 1));
  }
  ...
  public void facets_on_directories() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("directories")).containsOnly(new FacetBucket("/src/main/xoo", 1), new FacetBucket("/", 1));
  }
  ...
  public void facets_on_severities() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("severities")).containsOnly(new FacetBucket("INFO", 2), new FacetBucket("MAJOR", 1));
  }
  ...
  public void facets_on_statuses() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("statuses")).containsOnly(new FacetBucket("CLOSED", 2), new FacetBucket("OPEN", 1));
  }
  ...
  public void facets_on_resolutions() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("resolutions")).containsOnly(new FacetBucket("FALSE-POSITIVE", 2), new FacetBucket("FIXED", 1));
  }
  ...
  public void facets_on_action_plans() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("actionPlans")).containsOnly(new FacetBucket("plan1", 1), new FacetBucket("plan2", 1));
  }
  ...
  public void facets_on_languages() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("languages")).containsOnly(new FacetBucket("xoo", 1));
  }
  ...
  public void facets_on_assignees() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("assignees")).containsOnly(new FacetBucket("steph", 1), new FacetBucket("simon", 2), new FacetBucket("", 1));
  }
  ...
  public void facets_on_authors() throws Exception {
    ...
    assertThat(result.getFacets().getBuckets("authors")).containsOnly(new FacetBucket("steph", 1), new FacetBucket("simon", 2));
  }
  ...
  public void facet_on_created_at_with_less_than_20_days() throws Exception {
    ...
    Collection<FacetBucket> buckets = result.getFacets().getBuckets("createdAt");
    assertThat(buckets).containsOnly(
      new FacetBucket("2014-08-31T01:00:00+0000", 0),
      new FacetBucket("2014-09-01T01:00:00+0000", 2),
      new FacetBucket("2014-09-02T01:00:00+0000", 1),
      new FacetBucket("2014-09-03T01:00:00+0000", 0),
      new FacetBucket("2014-09-04T01:00:00+0000", 0),
      new FacetBucket("2014-09-05T01:00:00+0000", 1),
      new FacetBucket("2014-09-06T01:00:00+0000", 0),
      new FacetBucket("2014-09-07T01:00:00+0000", 0));
  }
  ...
  public void facet_on_created_at_with_less_than_20_weeks() throws Exception {
    ...
    Collection<FacetBucket> createdAt = index.search(IssueQuery.builder().createdAfter(DateUtils.parseDate("2014-09-01")).createdBefore(DateUtils.parseDate("2014-09-21")).build(),
      SearchOptions).getFacets().getBuckets("createdAt");
    assertThat(createdAt).containsOnly(
      new FacetBucket("2014-08-25T01:00:00+0000", 0),
      new FacetBucket("2014-09-01T01:00:00+0000", 4),
      new FacetBucket("2014-09-08T01:00:00+0000", 0),
      new FacetBucket("2014-09-15T01:00:00+0000", 1));
  }
  ...
  public void facet_on_created_at_with_less_than_20_months() throws Exception {
    ...
    Collection<FacetBucket> createdAt = index.search(IssueQuery.builder().createdAfter(DateUtils.parseDate("2014-09-01")).createdBefore(DateUtils.parseDate("2015-01-19")).build(),
      SearchOptions).getFacets().getBuckets("createdAt");
    assertThat(createdAt).containsOnly(
      new FacetBucket("2014-08-01T01:00:00+0000", 0),
      new FacetBucket("2014-09-01T01:00:00+0000", 5),
      new FacetBucket("2014-10-01T01:00:00+0000", 0),
      new FacetBucket("2014-11-01T01:00:00+0000", 0),
      new FacetBucket("2014-12-01T01:00:00+0000", 0),
      new FacetBucket("2015-01-01T01:00:00+0000", 1));
  }
  ...
  public void facet_on_created_at_with_more_than_20_months() throws Exception {
    ...
    Collection<FacetBucket> createdAt = index.search(IssueQuery.builder().createdAfter(DateUtils.parseDate("2011-01-01")).createdBefore(DateUtils.parseDate("2016-01-01")).build(),
      SearchOptions).getFacets().getBuckets("createdAt");
    assertThat(createdAt).containsOnly(
      new FacetBucket("2011-01-01T01:00:00+0000", 1),
      new FacetBucket("2012-01-01T01:00:00+0000", 0),
      new FacetBucket("2013-01-01T01:00:00+0000", 0),
      new FacetBucket("2014-01-01T01:00:00+0000", 5),
      new FacetBucket("2015-01-01T01:00:00+0000", 1),
      new FacetBucket("2016-01-01T01:00:00+0000", 0));
  ...
  public void facet_on_created_at_with_bounds_outside_of_data() throws Exception {
    ...
    Collection<FacetBucket> createdAt = index.search(IssueQuery.builder()
      .createdAfter(DateUtils.parseDate("2009-01-01"))
      .createdBefore(DateUtils.parseDate("2016-01-01"))
      .build(), options).getFacets().getBuckets("createdAt");
    assertThat(createdAt).containsOnly(
      new FacetBucket("2009-01-01T01:00:00+0000", 0),
      new FacetBucket("2010-01-01T01:00:00+0000", 0),
      new FacetBucket("2011-01-01T01:00:00+0000", 1),
      new FacetBucket("2012-01-01T01:00:00+0000", 0),
      new FacetBucket("2013-01-01T01:00:00+0000", 0),
      new FacetBucket("2014-01-01T01:00:00+0000", 5),
  ...
  public void facet_on_created_at_without_start_bound() throws Exception {
    ...
    Collection<FacetBucket> createdAt = index.search(IssueQuery.builder().createdBefore(DateUtils.parseDate("2016-01-01")).build(),
      SearchOptions).getFacets().getBuckets("createdAt");
    assertThat(createdAt).containsOnly(
        new FacetBucket("2011-01-01T01:00:00+0000", 1),
        new FacetBucket("2012-01-01T01:00:00+0000", 0),
  ...
  public void list_assignees() throws Exception {
    ...
    List<FacetBucket> results = index.searchForAssignees(IssueQuery.builder().statuses(newArrayList(Issue.STATUS_OPEN)).build());
